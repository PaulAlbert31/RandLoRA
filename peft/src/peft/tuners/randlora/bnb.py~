...
if is_bnb_available():
    ...
    class Linear8bitLt(torch.nn.Module, RandLoraLayer):
        ...
        def forward(self, x: torch.Tensor, *args, **kwargs) -> torch.Tensor:
            ...
            Note:
                This method implements the RandLora-specific forward pass. It applies the shared projections (randbasis_A and
                randbasis_B) along with the per-layer trainable parameters (lambda and gamma) to compute the adapter
                output.
            """
