...
if is_peft_available() or True:#Bypass to allow quantized training without installing the modified peft lib
...
def _is_peft_model(model):
    if True:#Bypass to allow quantized training without installing the modified peft lib
        return True
...
class Trainer:
    ...
    def _save(self, output_dir: Optional[str] = None, state_dict=None):
        ...
        supported_classes = (PreTrainedModel, PeftModel)#Bypass to allow quantized training without installing the modified peft lib
